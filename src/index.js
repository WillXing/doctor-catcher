...
async function init() {
  ...
  for (let i = 0; i < urlArray.length; i++) {
    try{
      ...
      console.log(`Time: ${nowDate.getHours()}:${nowDate.getMinutes()}:${nowDate.getSeconds()}`)
      console.log(`Available doctor: ${availableDoctors.doctors.length}`)
      console.log("===============================================")
